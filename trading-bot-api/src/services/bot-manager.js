...
var near_intents_1 = require("./near-intents");
var vercel_deploy_1 = require("./vercel-deploy");
var BotManager = /** @class */ (function (_super) {
    __extends(BotManager, _super);
    function BotManager(openaiApiKey, vercelToken, nearIntentsApiUrl, targetCoin, isTestnet) {
        ...
        _this.nearIntentsService = new near_intents_1.NearIntentsService(nearIntentsApiUrl);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        validationErrors = this.nearIntentsService.validateSwapRequest(request.swapConfig);
                    ...
                    case 1:
                        ...
                        this.nearIntentsService['baseUrl'], targetCoin, // Use the targetCoin from request
                        request.swapConfig);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.nearIntentsService.executeSwap(swapRequest)];
                    case 1:
                        result = _b.sent();
                        ...
                        bot.lastExecution = new Date();
                        // Log execution
                        this.logExecution(bot.id, action, currentPrice, swapRequest.amount, (_a = result.data) === null || _a === void 0 ? void 0 : _a.depositTxHash, result.success, result.error);
                        if (result.success) {
